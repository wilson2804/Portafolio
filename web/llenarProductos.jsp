...
<%
    ...
    while (rs.next()) {
        ...
        String codigojs = "var row = tbl_producto.insertRow(tbl_producto.rows.length);"
                ...
                + "cell.className = 'padsito';"
                + "cell.id = 'cantidad';"
                + "cell.innerHTML = '<input required= maxlength=3 onkeypress=\"solonumero(event)\" onkeyup=\"precio_" + codigo + ".innerHTML=this.value * " + precio + ";calcula_total();check_cantidad(this);\" type=text size=5 id=cantidad_" + rs.getLong(1) + "> ';"
