...
<html>
    <head>
        <%
            int id_boleta = Integer.parseInt(request.getParameter("id_boleta")) - 354656786;
            int id_usuario = Integer.parseInt(request.getParameter("id_usuario")) - 354656786;
            DAOProducto dao = new DAOProducto();
            DAOEmpleado daoE = new DAOEmpleado();
            Empleado emp = new Empleado();
            emp = daoE.buscarEmpleadoPorUsuario(id_usuario);
            Boleta_Cabecera ord = dao.datosBoleta(id_boleta);            
            pageContext.setAttribute("ordenes_detalle", dao.datosBoleta_detalle(id_boleta));
        %>
        ...
        <div class="panel panel-success" style="width: 97%">            
            <div class="table table-hover">
                <table border="0" cellspacing="20" style="width: 100%">
                    ...
                    <tr>
                        <td class="pad">NRO BOLETA: <%=id_boleta%><br></td>                                         
                    </tr>                
                    <tr>
                        <td class="pad">
