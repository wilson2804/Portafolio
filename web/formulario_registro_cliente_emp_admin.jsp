...
<html>
    ...
    <body>
        ...
        <div class="table-responsive">
            ...
            <br>
            <form action="ServletAgregar_ClienteEmpresa" method="POST" name="ejemplo">
                <table border="0" style="width: 100%">
                    <tr>
                        <td>
                                    ...
                                    <table border="0" style="width: 100%">
                                        <p style="font-size: 18px">Datos del Cliente:</p><br>
                                                <tr>
                                                   ...
                                                   <td align="left">
                                                       <input type="text" name="rut" maxlength="10" id="txt_rut" placeholder="20123543-k" class="form-control" style="width: 55%" onkeypress="rut(event)" onkeyup="valida_rut()"/>    
                                                   </td>
                                               </tr>
                                        <tr>
                                            <td style="width: 25%" class="pad">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="razonSocial" placeholder="EJ:Pesquera TranAntartic"  required="Debe completar este campo" class="form-control" style="width: 55%"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td nowrap class="pad">
                     ...
                     <input type="submit" class="btn btn-info" value="Registrar" align="center"  HTTP-EQUIV="REFRESH" CONTENT="URL=adm_cliente.jsp"> 
                    </td>
                    </tr>
                </table>
            </form>
