                ...
                <div class="table-responsive">
                    <table border="0" style="width: 100%">
                        <tr>
                            ...
                            <td>
                                <h4 align="right">¿Eres Empresa?</h4>
                            </td>
                        </tr>
                        <tr>
                            <td><p style="color:gray" align="left">* Todos los campos son obligatorios</p></td>
                            <td><a href="formulario_registro_cliente_emp.jsp"><button class="btn pull-right btn-info">Registrate Aqui</button></a></td>
                        </tr>
                    </table>
                </div>
            </div>
                                ...
                                <div class="panel-body">
                                    <table border="0" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <table border="0" cellspan="2">
                                                    <tr>
                                                        <td align="center" style="width: 25%">
                                                            <input type="text" name="rut" placeholder="EJ:12345678" required="" class="form-control" style="width: 95%"/>    
                                                        </td>
                                                        <td align="center" style="width: 2%"> - </td>
                                                        <td align="left">
                                                            <input type="text" name="dv" placeholder="9" required="" class="form-control" style="width: 10%"/>    
                                                        </td>
                                                    </tr>
                                                </table>    
                                            </td>
