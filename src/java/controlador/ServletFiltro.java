...
public class ServletFiltro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletFiltro</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletFiltro at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String tipo = request.getParameter("tipo");
        ...
        response.sendRedirect("adm_usuario.jsp");
            ...
            response.sendRedirect("adm_usuario.jsp?idtipo="+tipo+"&usuario="+buscar);
            }else{
            response.sendRedirect("adm_usuario.jsp?idtipo="+tipo+"&usuario="+buscar);
            }        
    }
